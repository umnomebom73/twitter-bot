...
print("🤖 Bot iniciado com personalidade caótica... (API v1.1)")
...
while True:
    try:
        ...
        # API v1.1 - busca tweets públicos
        ...
        if resposta:
            # Posta a resposta via v1.1 (funciona com plano free)
            api.update_status(
